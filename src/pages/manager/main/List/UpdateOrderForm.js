...
import { useUpdateOrderMutation, useGetOrderByIdQuery } from "../../../../context/service/orderApi";
        ...
        <Form form={form} layout="vertical" onFinish={handleSubmit}>
            <div className="">
                <Button
                    ...
                    onClick={() => navigate(-1)}
                />
                <h2 style={{ marginBottom: "20px", color: "#0A3D3A", textAlign: "center" }}>Buyurtmani Taxrirlash</h2>
            </div>
            {/* Buyurtma nomi, byudjet va to'langan summa */}
            <Row gutter={16}>
                <Col span={8}>
                    <Form.Item name="name" label="Buyurtma nomi" rules={[{ required: true }]}>
                        <Input />
                    </Form.Item>
                </Col>
                <Col span={8}>
                ...
                <Col span={8}>
                    <Form.Item name="estimatedDays" label="Taxminiy kunlar" rules={[{ required: true }]}>
                        <InputNumber style={{ width: "100%" }} />
                    </Form.Item>
                </Col>
            </Row>
            ...
            <Row gutter={16}>
                ...
                <Col span={8}>
                    <Form.Item name={["dimensions", "length"]} label="Uzunlik (m)" rules={[{ required: true }]}>
                        <InputNumber style={{ width: "100%" }} />
                    </Form.Item>
                </Col>
                <Col span={8}>
                    <Form.Item name={["dimensions", "width"]} label="Kenglik (m)" rules={[{ required: true }]}>
                        <InputNumber style={{ width: "100%" }} />
                    </Form.Item>
                </Col>
                <Col span={8}>
                    <Form.Item name={["dimensions", "height"]} label="Balandlik (m)" rules={[{ required: true }]}>
                        <InputNumber style={{ width: "100%" }} />
                    </Form.Item>
                </Col>
            </Row>
            ...
            <Row gutter={16}>
                ...
                <Col span={8}>
                    <Form.Item name={["customer", "type"]} label="Mijoz turi" rules={[{ required: true }]}>
                        <Select size="large">
                ...
                <Col span={8}>
                    <Form.Item name={["customer", "phone"]} label="Telefon raqami" rules={[{ required: true }]}>
                        <Input />
                    </Form.Item>
                </Col>
            </Row>
            ...
            <Row gutter={16}>
                <Col span={8}>
                    <Form.Item name={["customer", "fullName"]} label="To'liq ism (faqat jismoniy shaxs)">
                        <Input />
                    </Form.Item>
                </Col>
                <Col span={8}>
                    <Form.Item name={["customer", "companyName"]} label="Kompaniya nomi (faqat yuridik shaxs)">
                        <Input />
                    </Form.Item>
                </Col>
                <Col span={8}>
