    ...
    return (
        <div className="warehouse-container-view">
            <div className="warehouse-navbar-view">
                ...
                <Input style={{ width: "100%" }} placeholder="Mahsulotlarni qidiring..." onChange={(e) => setSearchQuery(e.target.value)} prefix={<SearchOutlined />} className="warehouse-navbar_inp-view" />
            </div>
