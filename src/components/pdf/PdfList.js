...
const ShohMebelTable = () => {
    ...
    // Default sana
    const [currentDateToday, setCurrentDate] = useState(dayjs().format("DD.MM.YYYY"));
    ...
    const columns = [
        {
            title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "17px" }}>Коммерческое предложение</i>,
            children: [
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>№</i>,
                    dataIndex: "key",
                    key: "key",
                    align: "center",
                    render: text => <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>{text}</i>,
                },
                {
                    title: (
                        <i style={{ fontFamily: "Arial, sans-serif", fontSize: "11px" }}> Наименование товара </i>
                    ),
                    render: (text) => {
                ...
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Ед.изм</i>,
                    align: "center",
                    dataIndex: "unit",
                    key: "unit",
                    render: () => <p style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>шт</p>,
                },
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Кол-во</i>,
                    dataIndex: "quantity",
                    key: "quantity",
                    align: "center",
                    render: text => <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>{text}</i>,
                ...
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Цена</i>,
                    dataIndex: "price",
                    key: "price",
                    align: "center",
                    render: text => <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>{text.toLocaleString("uz-UZ")}</i>,
                },
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Сумма</i>,
                    dataIndex: "budget",
                    key: "budget",
                    align: "right",
                    render: text => <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>{text}</i>,
                ...
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>НДС</i>,
                    children: [
                        {
                            title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Ставка</i>,
                            dataIndex: "discount",
                            key: "discount",
                            align: "center",
                            render: text => <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>{text}</i>,
                ...
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Стоимость с НДС</i>,
                ...
                {
                    title: <i style={{ fontFamily: 'Arial, sans-serif', fontSize: "11px" }}>Фото</i>,
                    dataIndex: "image",
                    key: "image",
                ...
                <Card>
                    ...
                    <div className="header-pdf-info">
                        <i className="header-pdf-box">
                            ...
                            <div>Адрес: {orderList?.address?.region} {orderList?.address?.district} {orderList?.address?.street}</div>
                            {
                                orderList.customer?.type === "Yuridik shaxs" &&
                                <>
                    ...
                    <Table
                        ...
                        bordered
                        summary={(pageData) => {
                            const formatNumber = (num) => (isNaN(num) ? "0" : Number(num).toLocaleString("uz-UZ"));
                            ...
                            // Calculate totals
                            const totalPrice = transformedPageData.reduce((sum, item) => sum + Number(item.price), 0);
                            const totalBudget = transformedPageData.reduce((sum, item) => sum + Number(item.budget), 0);
                            const totalVatAmount = transformedPageData.reduce((sum, item) => sum + Number(item.vatAmount), 0);
                            const totalPriceWithVAT = transformedPageData.reduce((sum, item) => sum + Number(item.totalPriceWithVAT), 0);

                            return (
                                <Table.Summary.Row>
                                    <Table.Summary.Cell index={0} colSpan={4}>
                                        <i style={{ fontFamily: "Arial, sans-serif", fontSize: "11px" }}>Итого</i>
                                    </Table.Summary.Cell>
                    ...
                    <Text style={{ display: "block", fontSize: "12px", marginTop: 20 }}>* Цены указаны с НДС</Text>
                    <Text style={{ display: "block", fontSize: "12px", }}>**Данное коммерческое предложение действительно до ({currentDateToday})</Text>
                    <Text style={{ display: "block", fontSize: "12px", }}>*** Условия предоплаты 50%. Цены указаны с НДС</Text>
                </Card>
            </div>
        </div>
    );
